![Banner](Data/Images/CSharp-Exercism-S02E01-Booleans-AnnalynsInfiltration-Banner.png)

### CSharp-Exercism-S02E01-Booleans-AnnalynsInfiltration

This repository my work for the [Exercism](https://exercism.org/) C# track.

### Download Command
`exercism download --track=csharp --exercise=annalyns-infiltration`
